...
public class ProductApiTest {
        ...
        // @ParameterizedTest
        // @MethodSource("categoryTestProvider")
        // public void testCategory(String expectedBody, String dbPath) throws Exception
        // {
        // IDatabaseTester databaseTester = new DataSourceDatabaseTester(dataSource);
        // URL givenUrl = this.getClass()
        // .getResource("src/test/resouces/category/" + dbPath + "/given/");
        // databaseTester.setDataSet(new CsvURLDataSet(givenUrl));
        // databaseTester.onSetup();

        // mockMvc.perform(
        // MockMvcRequestBuilders.get("/products/category/{category}")
        // .contentType(MediaType.APPLICATION_JSON)
        // .accept(MediaType.APPLICATION_JSON_UTF8))
        // .andExpect(MockMvcResultMatchers.status().isOk())
        // .andExpect((result) -> JSONAssert.assertEquals(
        ...
        // URL expectedUrl = this.getClass().getResource("/src/test/resources/category/"
        // + dbPath + "/expected/");
        ...
        // private static Stream<Arguments> categoryTestProvider() {
        // return Stream.of(
        // Arguments.arguments(
        // """
        // [
